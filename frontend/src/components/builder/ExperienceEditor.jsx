import { Briefcase, Trash2, Check, ChevronDown, ChevronUp, Type } from 'lucide-react';
...
const ExperienceEditor = ({ resume, setResume, enhanceWithAI, handleGrammarCheck, aiLoading, confirmDelete }) => {
  const { t } = useLanguage();
  ...
  const removeExperience = (index) => {
    ...
    }, "Delete Experience", "Are you sure you want to delete this work experience?");
  };
  ...
  return (
    <section>
      ...
      {showStyle && <SectionStylePanel sectionKey="experience" resume={resume} setResume={setResume} />}
